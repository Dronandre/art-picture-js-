...
var calc = function calc(size, material, options, promocode, result) {
  var sizeBlock = document.querySelector(size),
      ...
      promococodeBlock = document.querySelector(promocode),
  ...
  var calcFunc = function calcFunc() {
    ...
    } else if (promococodeBlock.value === 'IWANTPOPART') {
  ...
  promococodeBlock.addEventListener('input', calcFunc);
};
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      console.log(api); // запускаем фукцию отправки и получения данных
...
var modals = function modals() {
  var btnPressed; //Создаем функцию для модалок
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        btnPressed = true; // Удаляем триггер у модалки
